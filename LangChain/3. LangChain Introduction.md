...
![[Pasted image 20260222174810.png]]
...
**Emoji:** _(This is the end of the suffix, waiting for the AI to type '🐶')_

Below is a fully functioning example:

```python
# Step 1: Create the examples list of dicts
